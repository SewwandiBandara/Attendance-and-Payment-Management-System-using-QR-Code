...
import { FaGraduationCap, FaUserShield, FaChalkboardTeacher } from 'react-icons/fa';
            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-center gap-4 mb-4">
                        {[
                            ...
                            <button
                                ...
                                className={`flex flex-col items-center p-4 rounded-lg transition-all w-full ${formData.userType === type.value ? 'bg-sky-100 text-sky-800 ring-2 ring-sky-500' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                            >
                                {type.icon}
                    ...
                    <div className="flex gap-4">
                        <button
                            type="submit"
                            className="flex-1 bg-sky-800 text-white py-2 px-4 rounded-md font-semibold hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 transition"
                        >
                            Login
                        </button>
                        <button
